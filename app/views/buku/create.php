                ...
                <form action="/buku/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-4 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="isbn" id="isbn" class="form-control <?= error("isbn") ?>" placeholder="Masukkan kode buku..." value="<?= old("isbn") ?>">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select <?= error("kategori_id") ?>" id="kategori" name="kategori_id">
                                    ...
                                    <?php foreach (all("kategori_buku") as $kateg) : ?>
                                        <option value="<?= $kateg->id ?>" <?= old("kategori_id") == $kateg->id ? "selected" : "" ?>><?=$kateg->kode_kategori . "&nbsp;" . "-". "&nbsp;" . $kateg->nama_kategori ?></option>
                                    <?php endforeach ?>
                                </select>
                        ...
                        <div class="col-lg-4 mb-4">
                            <label for="sub_kategori_id" class="mb-2">Sub kategori <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">Text</span>
                                <select class="form-select <?= error("sub_kategori_id") ?>" id="kategori" name="sub_kategori_id">
                                    <option value="" selected>Pilih Sub Kategori</option>
                                    <?php foreach (all("sub_kategori") as $kategori) : ?>
                                        <option value="<?= $kategori->id ?>" <?= old("sub_kategori_id") == $kategori->id ? "selected" : "" ?>><?=$kategori->kode_sub_kategori . "&nbsp;" . "-". "&nbsp;" . $kategori->nama_sub_kategori ?></option>
                                    <?php endforeach ?>
                                </select>
                                <?php errorMessage("kategori_id") ?>
                            </div>
