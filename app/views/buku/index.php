                    ...
                    <tbody>
                        <?php foreach (all("buku") as $buku) : ?>
                            <tr class="text-nowrap">
                                ...
                                <td><?= get("sub_kategori", $buku->sub_kategori_id)->nama_sub_kategori ?></td>
                                                    ...
                                                    <div class="col-lg-9">
                                                        <ul class="list-group">
                                                            <li class="list-group-item d-flex">
                                                                <div class="col-lg-4">Kode Buku</div>
                                                                <div class="badge bg-success"><b><?= $buku->isbn ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div><b><?= get("kategori_buku", $buku->kategori_id)->kode_kategori . '&nbsp;' . '-' .'&nbsp;' . get("kategori_buku", $buku->kategori_id)->nama_kategori  ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                                <div class="col-lg-4">Kategori</div>
                                                                <div><b><?= get("sub_kategori", $buku->sub_kategori_id)->kode_sub_kategori . '&nbsp;' . '-' .'&nbsp;' . get("sub_kategori", $buku->sub_kategori_id)->nama_sub_kategori  ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
