...
$breadcrumbs = "
    ...
    <li class='breadcrumb-item'><a href='/buku/sub-kategori/edit?id=$id'>Edit Data</a></li>
";

$title = "Data Sub Kategori";
$subtitle = "Kelola data Sub kategori di halaman ini sesuai keperluan.";

$kategori = get("sub_kategori", $id);
    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <hr class="mx-4">
                <div class="card-body">
                    <form action="/buku/sub-kategori/update" method="POST">
                        <input hidden name="id" value="<?= $kategori->id ?>">
                     <div class="row">
                        <div class="col-lg-12 mb-4">
                            <label for="kategori_id" class="mb-2">Kategori <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">Text</span>
                                <select class="form-select <?= error("kategori_id") ?>" id="kategori" name="kategori_id">
                                    <option value="" selected>Pilih Kategori</option>
                                    <?php foreach (all("kategori_buku") as $kat) : ?>
                                        <option value="<?= $kat->id ?>" <?= old("kategori_id", $kategori->kategori_id) == $kat->id ? "selected" : "" ?>><?= $kat->nama_kategori ?></option>
                                    <?php endforeach ?>
                                </select>
                            ...
                            <div class="col mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="kode_sub_kategori" id="kode_sub_kategori" class="form-control <?= error("kode_sub_kategori") ?>" placeholder="Masukkan nama sub kategori..." value="<?= old("kode_sub_kategori", $kategori->kode_sub_kategori) ?>">
                            ...
                            <div class="col">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="nama_sub_kategori" id="nama_sub_kategori" class="form-control <?= error("nama_sub_kategori") ?>" placeholder="Masukkan nama sub kategori..." value="<?= old("nama_sub_kategori", $kategori->nama_sub_kategori) ?>">
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Apakah anda yakin ingin menghapus <b><?= $kategori->nama_sub_kategori ?></b>? Data yang sudah dihapus tidak dapat dikembalikan!
                                                    </div>
