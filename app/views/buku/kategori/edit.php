            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/buku/kategori/update" method="POST">
                        ...
                        <div class="row">
                            <div class="col mb-4">
                                <label for="nama_kategori" class="mb-2">Kode Kategori <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="kode_kategori" id="kode_kategori" class="form-control <?= error("kode_kategori") ?>" placeholder="Masukkan nama kategori..." value="<?= old("kode_kategori", $kategori->kode_kategori) ?>">
                                    <?php errorMessage("kode_kategori") ?>
                                </div>
                            </div>
                            <div class="col mb-4">
