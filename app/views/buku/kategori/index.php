            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/buku/kategori/store" method="POST">
                        <div class="row">
                            <div class="col mb-4">
                                <label for="kode_kategori" class="mb-2">Kode Kategori<span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text">#</span>
                                        <input type="number"  name="kode_kategori" id="kode_kategori" class="form-control <?= error("kode_kategori") ?>" placeholder="Masukkan kode kategori..." value="<?= old("kode_kategori") ?>">
