                ...
                <form action="/buku/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-4">
                            <label for="isbn" class="mb-2">Kode Buku <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                                <input name="isbn" id="isbn" class="form-control <?= error("isbn") ?>"
                                    placeholder="Masukkan isbn..." value="<?= old("isbn", $buku->isbn) ?>">
                        ...
                        <div class="col-lg mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select <?= error("kategori_id") ?>" id="kategori"
                                    name="kategori_id">
                        ...
                        <div class="col-lg mb-4">
                            <label for="sub_kategori" class="mb-2">Sub Kategori <span
                                    class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">Text</span>
                                <select class="form-select <?= error("sub_kategori_id") ?>" id="sub_kategori"
                                    name="sub_kategori_id">
                                    <option value="" selected>Pilih Kategori</option>
                                    <?php foreach (all("sub_kategori") as $subkategori) : ?>
                                    <option value="<?= $subkategori->id ?>"
                                        <?= old("sub_kategori_id", $buku->sub_kategori_id) == $subkategori->id ? "selected" : "" ?>>
                                        <?= $subkategori->nama_sub_kategori ?></option>
                                    <?php endforeach ?>
                                </select>
                                <?php errorMessage("sub_kategori_id") ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="judul" id="judul" class="form-control <?= error("judul") ?>"
                                        placeholder="Masukkan judul..." value="<?= old("judul", $buku->judul) ?>">
                            ...
                            <div class="col-lg mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="pengarang" id="pengarang"
                            ...
                            <div class="col-lg mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="penerbit" id="penerbit" class="form-control <?= error("penerbit") ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg mb-4">
                            <label for="tahun_terbit" class="mb-2">Tahun Terbit <span
                                    class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                        ...
                        <div class="col-lg mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="jumlah_buku" id="jumlah_buku"
                                    class="form-control <?= error("jumlah_buku") ?>"
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select <?= error("lokasi_id") ?>" id="lokasi" name="lokasi_id">
                                    ...
                                    <option value="<?= $lokasi->id ?>"
                                        <?= old("lokasi_id", $buku->lokasi_id) == $lokasi->id ? "selected" : "" ?>>
                    ...
                    <div class="row">
                        <div class="col-lg mb-4">
                            <label for="total_halaman" class="mb-2">Total Halaman <span
                                    class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                                <input type="number" name="total_halaman" id="total_halaman"
                                    class="form-control <?= error("total_halaman") ?>"
                        ...
                        <div class="col-lg mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga" id="harga" class="form-control <?= error("harga") ?>"
                                    placeholder="Masukkan harga..." value="<?= old("harga", $buku->harga) ?>">
                    ...
                    <div class="row">
                        <div class="col-lg mb-4">
                            ...
                            <div class="form-group ">
                                <textarea class="form-control <?= error("keterangan") ?>" name="keterangan"
                                    id="keterangan" style="height: 150px;"
                                    placeholder="Masukkan keterangan..."><?= old("keterangan", $buku->keterangan) ?></textarea>
