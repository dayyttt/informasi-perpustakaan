...
if($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	if($_POST["print"] == "buku-rusak") {
		$path = "laporan/transaksi/data_buku-rusak.php";
		$file_name = "laporan-buku-rusak.pdf";
	}
	if($_POST["print"] == "buku-rusak") {
		$path = "laporan/transaksi/data-peminjaman-guru.php";
		$file_name = "laporan-peminjaman-guru.pdf";
	}
