<?php 
	...
	$data = Capsule::table("peminjaman_guru")->whereBetween("tanggal_peminjaman", [$tanggal_awal, $tanggal_akhir]);
	if($status != "") {
	...
	<tbody>
		...
		<?php foreach ($data as $key => $peminjaman) : ?>
			<tr>
                ...
                <td><?= sumWhere("detail_peminjaman_guru", "guru_id", $peminjaman->id, "jumlah_buku") ?> buah</td>
