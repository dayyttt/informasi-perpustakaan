...
$data = Capsule::table("buku")->where("judul", "like", "%$judul%")->and("pengarang","like","%$pengarang%")->orderBy("id", "DESC")->get();
...
foreach($data as $key => $value) {
	$data[$key] = [
		...
		"sub_kategori_id" => get("sub_kategori", $value->kategori_id)->nama_kategori,
