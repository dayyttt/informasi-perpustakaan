...
$sub_path = "/transaksi/peminjaman-kelas";

$breadcrumbs = "
    <li class='breadcrumb-item'><a href='/transaksi'>Transaksi</a></li>
    <li class='breadcrumb-item'><a href='/transaksi/peminjaman-kelas'>Peminjaman</a></li>
";
    ...
    <div class="card">
        <div class="card-header pb-2 d-flex justify-content-between align-items-center">
            ...
            <div class="badge bg-light-success">
                <?= codePeminjamanRombongan() ?>
            </div>
        </div>
        <hr class="mx-4">
        <div class="card-content">
            <div class="card-body">
                <form action="/transaksi/peminjaman-kelas/store" method="POST">
                    <div class="row">
