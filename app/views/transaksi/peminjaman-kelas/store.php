...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $peminjaman_id = latter("rombongan") + 1;
    $detail_peminjaman = [];
    

    if (validation(peminjamanRombonganRules(), $_POST)) {
        if($_POST["batas_pengembalian"] < date("Y-m-d")) {
            ...
            return header("Location: /transaksi/peminjaman-kelas");
        }
        ...
        insert("detail_peminjaman_rombongan", $detail_peminjaman);
