...
$sub_path = "/transaksi/pengembalian-guru";

$breadcrumbs = "
    <li class='breadcrumb-item'><a href='/transaksi'>Transaksi</a></li>
    <li class='breadcrumb-item'><a href='/transaksi/pengembalian-guru'>Pengembalian</a></li>
";
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        <?php foreach (all("peminjaman_guru") as $peminjaman) : ?>
                            <tr class="text-nowrap">
                                <td><?= codePeminjamanGuru($peminjaman->id) ?></td>
                                <td><?= get("guru", $peminjaman->guru_id)->nama ?></td>
                                <td><?= $peminjaman->tanggal_peminjaman ?></td>
                                <td><?= $peminjaman->batas_pengembalian ?></td>
                                <td><?= dendaGuru($peminjaman->id) ?></td>
                                <td><?= statusPeminjamanGuruDisplay($peminjaman->id) ?></td>
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus <b><?= codePeminjamanGuru($peminjaman->id) ?></b>? Data yang sudah dihapus tidak dapat dikembalikan!
                                            </div>
                                            <div class="modal-footer">
                                                <form action="/transaksi/pengembalian-guru/delete" method="POST">
                                            ...
                                            <div class="modal-body p-4">
                                                    ...
                                                    <div class="col-lg">
                                                        <ul class="list-group">
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div class="badge bg-success"><?= codePeminjamanGuru($peminjaman->id) ?></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                                <div class="col-lg-4">Nama Guru Peminjam</div>
                                                                <div><b><?= get("guru", $peminjaman->guru_id)->nama ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div><b><?= dendaGuru($peminjaman->id, $peminjaman->batas_pengembalian) ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div><b><?= statusPeminjamanGuruDisplay($peminjaman->id) ?></b></div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <?php if($peminjaman->status == 0) : ?>
                                                    <div class="alert bg-black text-white d-flex justify-content-between align-items-center">
                                                        ...
                                                        <form action="/transaksi/pengembalian-guru/kembalikansemua" method="POST">
                                                            <input hidden name="id" value="<?= $peminjaman->id ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg">
                                                        <ul class="list-group">
                                                            ...
                                                            <?php foreach (allWhere("detail_peminjaman_guru", "guru_id", $peminjaman->id) as $key => $detail_peminjaman) : ?>
                                                                <li class="list-group-item d-flex">
                                                                    ...
                                                                    <div class="col-lg"><?= statusDetailPeminjamanGuru($detail_peminjaman->id) ?></div>
                                                                    <div class="col-lg">
                                                                        <?php if ($detail_peminjaman->status == 0) : ?>
                                                                            <form action="/transaksi/pengembalian-guru/kembalikan" method="POST">
                                    ...
                                    <div class="modal fade text-left" id="perpanjangan<?= $peminjaman->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-4">
                                                  <form action="/transaksi/pengembalian-guru/perpanjangan" method="POST">
                                                        <input hidden name="id" value="<?= $peminjaman->id ?>">
                                                        <div class="row">
                                    ...
                                    <div class="modal fade text-left" id="bayardenda<?= $peminjaman->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="/transaksi/pengembalian-guru/bayardenda" method="POST">
                                                        <input hidden name="id" value="<?= $peminjaman->id ?>">
                                                        <div class="row">
                                                            <div class="col-auto ms-auto">
                                                                <button type="submit" class="btn btn-primary px-4">Proses</button>
