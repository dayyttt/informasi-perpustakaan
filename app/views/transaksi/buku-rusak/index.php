...
$sub_path = "/transaksi/buku-rusak";

$breadcrumbs = "
    <li class='breadcrumb-item'><a href='/transaksi'>Transaksi</a></li>
    <li class='breadcrumb-item'><a href='/transaksi/buku-Rusak'>Buku Rusak</a></li>
";

$title = "Data Buku Rusak";
$subtitle = "Berisi informasi lengkap tentang buku rusak.";
...
<section class="section mb-4">
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                   <h4 class="mb-0"><?= sum("buku_rusak", "jumlah_buku") ?> buah</h3>
                </div>
            </div>
        </div>
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                   <h4 class="mb-0"><?= rp(Capsule::table("buku_rusak")->selectRaw("SUM(jumlah_buku * harga) AS total_kerugian")->where("status", 1)->first()->total_kerugian) ?></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-header pb-2 d-flex justify-content-between align-items-center">
            ...
            <a href="/transaksi/buku-rusak/create" class="btn btn-primary px-4">Tambah Data</a>
        </div>
        <hr class="mx-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        <?php foreach (all("buku_rusak") as $buku_hilang) : ?>
                            <tr class="text-nowrap">
                                <td><?= codeBukuRusak($buku_hilang->id) ?></td>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus <b><?= codeBukuRusak($buku_rusak->id) ?></b>? Data yang sudah dihapus tidak dapat dikembalikan!
                                            </div>
                                            <div class="modal-footer">
                                                <form action="/transaksi/buku-rusak/delete" method="POST">
                                                    ...
                                                    <div class="col-lg">
                                                        <ul class="list-group">
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div class="badge bg-success"><?= codeBukuRusak($buku_rusak->id) ?></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                    ...
                                    <div class="modal fade text-left" id="bayarkerugian<?= $buku_hilang->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="/transaksi/buku-rusak/bayarkerugian" method="POST">
                                                        <input hidden name="id" value="<?= $buku_hilang->id ?>">
                                                        <div class="row">
