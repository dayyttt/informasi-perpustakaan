...
$breadcrumbs = "
    ...
    <li class='breadcrumb-item'><a href='/transaksi/buku-rusak/create'>Tambah Data</a></li>
";

$title = "Tambah Data Buku Rusak";
...
<section class="section mb-4">
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form action="/transaksi/buku-rusak/store" method="POST">
                    <div class="row">
