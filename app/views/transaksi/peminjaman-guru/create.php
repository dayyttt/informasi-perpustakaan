...
$sub_path = "/transaksi/peminjaman-guru";
...
<section class="section mb-4">
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form action="/transaksi/peminjaman-guru/store" method="POST">
                    <div class="row">
                        ...
                        <div class="col-lg mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input readonly value="<?= date("Y-m-d", time() + 432000) ?>"name="batas_pengembalian" id="batas_pengembalian" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg mb-4">
                            <label for="guru" class="mb-2">Guru <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">Text</span>
                                  <select class="form-select <?= error("guru_id") ?>" id="guru" name="guru_id">
                                    <option value="" selected>Pilih Guru</option>
                                    <?php foreach (all("guru") as $guru) : ?>
                                        <option value="<?= $guru->id ?>" <?= old("guru_id") == $guru->id ? "selected" : "" ?>><?= $guru->nama ?></option>
                                    <?php endforeach ?>
                                </select>
                                <?php errorMessage("guru_id") ?>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <?php foreach (all("buku") as $buku) : ?>
                                <tr class="text-nowrap">
                                    ...
                                    <td>
                                        <a href="#" class="badge bg-success text-white me-1 select-book" data-bs-dismiss="modal" data-code="<?= $buku->isbn ?>" data-buku='<?= allWhere("buku", "id", $buku->id) ?>'>Pilih</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
