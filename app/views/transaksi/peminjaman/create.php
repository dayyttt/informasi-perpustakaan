                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-lg mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input readonly value="<?= old("denda", first("denda")->besaran_denda) ?>"  name="denda" id="denda" class="form-control <?= error("denda") ?>" ><br>
                                <?php errorMessage("denda") ?>
                            </div>
                          <small><i>Note: Denda akan berlaku jika lewat dari batas pengembalian.</i></small>
                        </div> -->
                    </div>
                    <hr>
                    <div class="row">
