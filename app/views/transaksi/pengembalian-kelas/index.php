...
$sub_path = "/transaksi/pengembalian-kelas";

$breadcrumbs = "
    <li class='breadcrumb-item'><a href='/transaksi'>Transaksi</a></li>
    <li class='breadcrumb-item'><a href='/transaksi/pengembalian-kelas'>Pengembalian</a></li>
";
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        <?php foreach (all("rombongan") as $peminjaman) : ?>
                            <tr class="text-nowrap">
                                ...
                                <td><?= statusPeminjamanRombonganDisplay($peminjaman->id) ?></td>
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus <b><?= codePeminjamanRombongan($peminjaman->id) ?></b>? Data yang sudah dihapus tidak dapat dikembalikan!
                                            </div>
                                            <div class="modal-footer">
                                                <form action="/transaksi/pengembalian-kelas/delete" method="POST">
                                            ...
                                            <div class="modal-body p-4">
                                                    ...
                                                    <div class="col-lg">
                                                        <ul class="list-group">
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div class="badge bg-success"><?= codePeminjamanRombongan($peminjaman->id) ?></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                <div class="col-lg-4">Kelas Peminjam</div>
                                                                <div><b><?= get("kelas_anggota", $peminjaman->kelas_id)->nama_kelas ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div><b><?= dendaRombongan($peminjaman->id, $peminjaman->batas_pengembalian) ?></b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div><b><?= statusPeminjamanRombonganDisplay($peminjaman->id) ?></b></div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <?php if($peminjaman->status == 0) : ?>
                                                    <div class="alert bg-black text-white d-flex justify-content-between align-items-center">
                                                        ...
                                                        <form action="/transaksi/pengembalian-kelas/kembalikansemua" method="POST">
                                                            <input hidden name="id" value="<?= $peminjaman->id ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg">
                                                        <ul class="list-group">
                                                            ...
                                                            <?php foreach (allWhere("detail_peminjaman_rombongan", "rombongan_id", $peminjaman->id) as $key => $detail_peminjaman) : ?>
                                                                <li class="list-group-item d-flex">
                                                                    <!-- <?php var_dump($detail_peminjaman)?> -->
                                                                    ...
                                                                    <div class="col-lg"><?= statusDetailPeminjamanRombongan($detail_peminjaman->id) ?></div>
                                                                    <div class="col-lg">
                                                                        <?php if ($detail_peminjaman->status == 0) : ?>
                                                                            <form action="/transaksi/pengembalian-kelas/kembalikan" method="POST">
                                    ...
                                    <div class="modal fade text-left" id="perpanjangan<?= $peminjaman->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-4">
                                                  <form action="/transaksi/pengembalian-kelas/perpanjangan" method="POST">
                                                        <input hidden name="id" value="<?= $peminjaman->id ?>">
                                                        <div class="row">
                                    ...
                                    <div class="modal fade text-left" id="bayardenda<?= $peminjaman->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="/transaksi/pengembalian-kelas/bayardenda" method="POST">
                                                        <input hidden name="id" value="<?= $peminjaman->id ?>">
                                                        <div class="row">
                                                            <div class="col-auto ms-auto">
                                                                <button type="submit" class="btn btn-primary px-4">Proses</button>
