    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center mt-2">
                <div class="logo">
                    <h3 class="mb-0 font-extrabold fs-6 text-uppercase"><a href="/" class="text-black"><?= APP_NAME ?></a></h3>
                </div>
        ...
        <div class="sidebar-menu">
            <?php if($_SESSION["type"] == "pengguna") : ?>
                <ul class="menu">
                    ...
                    <!-- <li class="sidebar-item <?= $base_path == "/guru" ? "active" : "" ?> has-sub">
                        <a href="#" class='sidebar-link'>
                            <i class="bi bi-person-lines-fill"></i>
                            <span>Guru</span>
                        </a>
                        <ul class="submenu <?= $base_path == "/guru" ? "active" : "" ?>">
                            <li class="submenu-item <?= $sub_path == "/guru" ? "active" : "" ?>">
                                <a href="/guru">Data guru</a>
                            </li>
                            <li class="submenu-item <?= $sub_path == "/guru/kelas" ? "active" : "" ?>">
                    ...
                    <li class="sidebar-item <?= $base_path == "/buku" ? "active" : "" ?> has-sub">
                        ...
                        <ul class="submenu <?= $base_path == "/buku" ? "active" : "" ?>">
                            ...
                            <li class="submenu-item <?= $sub_path == "/buku/sub-kategori" ? "active" : "" ?>">
                                <a href="/buku/sub-kategori">Sub Kategori</a>
                            </li>
                    ...
                    <li class="sidebar-item <?= $base_path == "/transaksi" ? "active" : "" ?> has-sub">
                        ...
                        <ul class="submenu <?= $base_path == "/transaksi" ? "active" : "" ?>">
                            ...
                            <li class="submenu-item <?= $sub_path == "/transaksi/peminjaman" ? "active" : "" ?>">
                                <a href="/transaksi/peminjaman">Peminjaman Siswa</a>
                            </li>   
                            <li class="submenu-item <?= $sub_path == "/transaksi/pengembalian" ? "active" : "" ?>">
                                <a href="/transaksi/pengembalian">Pengembalian Siswa</a>
                            </li>
                            <li class="submenu-item <?= $sub_path == "/transaksi/peminjaman-kelas" ? "active" : "" ?>">
                                <a href="/transaksi/peminjaman-kelas">Peminjaman Kelas</a>
                            </li>   
                            <li class="submenu-item <?= $sub_path == "/transaksi/pengembalian-kelas" ? "active" : "" ?>">
                                <a href="/transaksi/pengembalian-kelas">Pengembalian Kelas</a>
                            </li>
                            <li class="submenu-item <?= $sub_path == "/transaksi/peminjaman-guru" ? "active" : "" ?>">
                                <a href="/transaksi/peminjaman-guru">Peminjaman Guru</a>
                            </li>   
                            <li class="submenu-item <?= $sub_path == "/transaksi/pengembalian-guru" ? "active" : "" ?>">
                                <a href="/transaksi/pengembalian-guru">Pengembalian Guru</a>
                            </li>
                            ...
                            <li class="submenu-item <?= $sub_path == "/transaksi/buku-rusak" ? "active" : "" ?>">
                                <a href="/transaksi/buku-rusak">Buku Rusak</a>
                            </li>
                         </ul>
                    </li>
