...
$breadcrumbs = "
    ...
    <li class='breadcrumb-item'><a href='/guru/create'>Tambah Data</a></li>
";

$title = "Tambah Data Guru";
$subtitle = "Halaman ini digunakan untuk menambah data guru.";
            ...
            <div class="card-body">
                <form action="/guru/store" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg mb-4">
                            <label for="nis" class="mb-2">NIP <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                                <input type="number" name="nip" id="nip" class="form-control <?= error("nip") ?>" placeholder="Masukkan nis..." value="<?= old("nip") ?>">
                        ...
                        <label for="pend_terakhir" class="mb-2">Pendidikan Terakhir <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">Text</span>
                                <input name="pend_terakhir" id="pend_terakhir" class="form-control <?= error("pend_terakhir") ?>" placeholder="Masukkan pendidikan terakhir..." value="<?= old("pend_terakhir") ?>">
