...
if($type === "pengguna") {
	...
	Route::url("/guru", "guru/index");
	Route::url("/guru/edit", "guru/edit");
	if(isAdmin()) {
		Route::url("/guru/create", "guru/create");
		Route::url("/guru/store", "guru/store");
		Route::url("/guru/update", "guru/update");
		Route::url("/guru/delete", "guru/delete");
		Route::url("/guru/ubahpassword/edit", "guru/ubahpassword/edit");
		Route::url("/guru/ubahpassword/update", "guru/ubahpassword/update");
	...
	Route::url("/buku/sub-kategori", "buku/sub-kategori/index");  
	Route::url("/buku/sub-kategori/store", "buku/sub-kategori/store");  
	Route::url("/buku/sub-kategori/edit", "buku/sub-kategori/edit"); 
	Route::url("/buku/sub-kategori/update", "buku/sub-kategori/update");  
	Route::url("/buku/sub-kategori/delete", "buku/sub-kategori/delete"); 
	...
	Route::url("/transaksi/peminjaman-kelas", "transaksi/peminjaman-kelas/create");  
	Route::url("/transaksi/peminjaman-kelas/store", "transaksi/peminjaman-kelas/store"); 
	Route::url("/transaksi/pengembalian-kelas", "transaksi/pengembalian-kelas/index"); 
	Route::url("/transaksi/pengembalian-kelas/delete", "transaksi/pengembalian-kelas/delete");  
	Route::url("/transaksi/pengembalian-kelas/kembalikan", "transaksi/pengembalian-kelas/kembalikan"); 
	Route::url("/transaksi/pengembalian-kelas/kembalikansemua", "transaksi/pengembalian-kelas/kembalikansemua"); 
	Route::url("/transaksi/pengembalian-kelas/perpanjangan", "transaksi/pengembalian-kelas/perpanjangan"); 
	Route::url("/transaksi/pengembalian-guru/bayardenda", "transaksi/pengembalian-guru/bayardenda"); 
	
	Route::url("/transaksi/peminjaman-guru", "transaksi/peminjaman-guru/create");  
	Route::url("/transaksi/peminjaman-guru/store", "transaksi/peminjaman-guru/store"); 
	Route::url("/transaksi/pengembalian-guru/delete", "transaksi/pengembalian-guru/delete");  
	Route::url("/transaksi/pengembalian-guru", "transaksi/pengembalian-guru/index"); 
	Route::url("/transaksi/pengembalian-guru/kembalikan", "transaksi/pengembalian-guru/kembalikan"); 
	Route::url("/transaksi/pengembalian-guru/kembalikansemua", "transaksi/pengembalian-guru/kembalikansemua"); 
	Route::url("/transaksi/pengembalian-guru/perpanjangan", "transaksi/pengembalian-guru/perpanjangan"); 
	Route::url("/transaksi/pengembalian-guru/bayardenda", "transaksi/pengembalian-guru/bayardenda"); 
	...
	Route::url("/transaksi/buku-rusak", "transaksi/buku-rusak/index"); 
	Route::url("/transaksi/buku-rusak/create", "transaksi/buku-rusak/create"); 
	Route::url("/transaksi/buku-rusak/store", "transaksi/buku-rusak/store"); 
	Route::url("/transaksi/buku-rusak/bayarkerugian", "transaksi/buku-rusak/bayarkerugian"); 
	Route::url("/transaksi/buku-rusak/delete", "transaksi/buku-rusak/delete"); 
	...
	Route::url("/u/guru/dashboard", "u/guru/dashboard"); 

	Route::url("/u/guru/buku", "u/guru/buku"); 

	Route::url("/u/guru/transaksi", "u/guru/transaksi/index"); 
	Route::url("/u/guru/transaksi/peminjaman", "u/guru/transaksi/peminjaman/create"); 
	Route::url("/u/guru/transaksi/peminjaman/store", "u/guru/transaksi/peminjaman/store"); 
	Route::url("/u/guru/transaksi/denda", "u/guru/transaksi/denda"); 

	Route::url("/u/guru/profil", "u/guru/profil/index"); 
	Route::url("/u/guru/profil/edit", "u/guru/profil/edit"); 
	Route::url("/u/guru/profil/update", "u/guru/profil/update"); 
	Route::url("/u/guru/profil/ubahpassword", "u/guru/profil/ubahpassword/edit");
	Route::url("/u/guru/profil/ubahpassword/update", "u/guru/profil/ubahpassword/update");
	Route::url("/u/guru/profil/kartu", "u/guru/profil/kartu"); 

	Route::url("/u/guru/pengaturan", "u/guru/pengaturan"); 
}
