...
<h2 id="demo">Halaman Demo</h2>
 ...
 driver databasenya gak bisa pake mysql, mau gak mau pake heroku postgresql. jadi yaudahlah kalo mau coba websitenya langsung aja cus clone reponya yaahh :* Oh iya setelah install nanti kalo mau coba login pake akun admin. username: admin, password: admin
